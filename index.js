...
// MONGO DB ROUTES
const uri= `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@yogamaster.evrrqhg.mongodb.net/?retryWrites=true&w=majority&appName=yogaMaster`
...
async function run() {
    try {
        ...
        const database = client.db("yoga-master31");
